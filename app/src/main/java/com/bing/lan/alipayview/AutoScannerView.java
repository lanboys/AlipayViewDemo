...
public class AutoScannerView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String text = "目前仅支持 Printcenter 365 WIFI 小票打印机";
...
//            canvas.drawLine(frame.left, frame.top + lineOffsetCount, frame.right, frame.top + lineOffsetCount, linePaint);    //画一条红色的线
            ...
            canvas.drawBitmap(((BitmapDrawable)(getResources().getDrawable(R.drawable.scanline_yellow))).getBitmap(), null, lineRect, linePaint);
        }
