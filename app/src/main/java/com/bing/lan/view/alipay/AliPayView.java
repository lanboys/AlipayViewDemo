...
public class AliPayView extends View {
    ...
    private int radius = 150;//旋转圆的半径(修改此值可以改变圆的大小)
    private float increaseDis = 1f;//对勾增长速率(修改此值可以改变打对勾的速率)
    private float circleIncRate = 1f;//圆圈增长速率(修改此值可以改变画圆的速率)
    private int sweepMaxAngle = 200;//正在支付状态的最大圆弧长度(修改此值可以改变最大圆弧的长度)
    ...
    public String onSizeChangedPrint() {
        return "AlipayView{" +
                "mCenterX=" + mCenterX +
                ", mCenterY=" + mCenterY +
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        log.i("onSizeChanged():  " + h);
        log.i("onSizeChanged():  " + oldw);
        log.i("onSizeChanged():  " + oldh);
        ...
        switch (state) {
            ...
            case PROGRESS:
                ...
                if (secondProgress < sweepMaxAngle) {
                    ...
                    log.i("onDraw(): 1111111111111111111");
                    ...
                    log.i("onDraw(): 111111111111111111122222222222222222222");
                } else if (secondProgress > 360) {
                    log.i("onDraw(): 11111111111111111112222222222222222222233333333333333333333");
                    if (sweepLength > 0) {
